...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">    
    ...
    <div runat="server" ID="CreateProductForm">
        ...
        <asp:DropDownList ID="CategoryList" runat="server" DataTextField="CategoryName" DataValueField="CategoryID" ItemType="WingtipToys.Data.Category" SelectMethod="GetCategories"></asp:DropDownList>
